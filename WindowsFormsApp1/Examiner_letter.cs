        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            while (dr.Read())
            {
                ...
                if (dr2.Read())
                {
                    ...
                    PdfWriter pwriter = PdfWriter.GetInstance(doc, new FileStream("D:\\ABHISHEK\\WORK2022C\\PDF LETTERS\\EXMLETTER\\" + dr["sch_no"].ToString() + "_" + dr["HENO"].ToString() + "_" + dr["slno"].ToString() + "_EX2022.pdf", FileMode.Create));
                    ...
                    var rosign2 = iTextSharp.text.Image.GetInstance("C:\\Users\\Acer\\source\\repos\\ropatna\\CompLetters\\WindowsFormsApp1\\images\\rosignpng.png");
                    ...
                    rosign.SetAbsolutePosition(470, 325);
                    ...
                    void exm(Document pdoc)
                    {
                        ...
                        pdoc.Add(p3);
                        Paragraph p4 = new Paragraph(str: "No.:CBSE/RO-PTN/EXAM/SPOT/COMP 2022/" + dr2["hesub"].ToString() + " - " + dr["SLNO"].ToString() + "/REVISED                      Date:" + date_str) { Alignment = Element.ALIGN_LEFT };
                        pdoc.Add(p4);
                        ...
                        pdoc.Add(p5);
                        Paragraph p6 = new Paragraph(str: "\nSUB.:  APPOINTMENT LETTER CUM INTIMATION OF VENUE FOR SPOT EVALUATION FOR EXAMINERS IN THE SUBJECT " + dr2["subname"].ToString() + "(" + dr2["hesub"].ToString() + ") OF CLASS " + dr2["heclass"].ToString() + " Compartment Exam 2022") { Alignment = Element.ALIGN_LEFT };
                        pdoc.Add(p6);
                        Paragraph p7 = new Paragraph(str: "\nSir/Madam,\n\n") { Alignment = Element.ALIGN_LEFT };
                        pdoc.Add(p7);
                        Paragraph p8 = new Paragraph(str: "      I am to inform you that you have  been  appointed as  Examiner for Evaluation  of  Answer Books of the subject mentioned above of class " + dr2["heclass"].ToString() + " for Compartment Examinations 2022.  The Evaluation work will be done at the following address:-\n") { Alignment = Element.ALIGN_JUSTIFIED };
                        pdoc.Add(p8);
                        ...
                        tbl2.AddCell(new Phrase(str: dr2["HENAME"].ToString() + "  (HE No.: " + dr2["heno"].ToString() + " )\n" + dr2["HEADD1"].ToString() + "(School No.: "+ dr2["SCH_NO"].ToString() + ")\n" + dr2["HEADD2"].ToString() + "\n" + dr2["HEADD3"].ToString() + "\n" + dr2["HEADD4"].ToString() + "\n" + dr2["HEADD5"].ToString() + "\nPIN: " + dr2["HEPIN"].ToString() + "\n"));
                        tbl2.AddCell(new Phrase(str: "\nMobile : " + dr2["MOBILE"].ToString() + "\n\nEmail:  " + dr2["heemail"].ToString() + "\n"));
                        pdoc.Add(tbl2);
                        Paragraph p101 = new Paragraph(str: "\nThe appointment as well as the information to  this  effect  will be kept strictly confidential by you.") { Alignment = Element.ALIGN_LEFT };
                        pdoc.Add(p101);
